...
const BUILTIN_COMMANDS: Command[] = [
  ...
  { name: '/clear-todos', description: 'Remove all todos' },
  { name: '/save', description: 'Save session', hint: 'F5' },
  { name: '/load', description: 'Load session', hint: 'F6' },
  { name: '/sessions', description: 'List saved conversation hashes' },
  { name: '/resume', description: 'Resume a conversation by hash' },
  { name: '/rename', description: 'Rename current session' },
  { name: '/delete-session', description: 'Delete a saved session' },
  { name: '/copy', description: 'Copy message content to clipboard' },
  ...
  { name: '/skill-load', description: 'Load a skill by name' },
  { name: '/unload', description: 'Unload a skill' },
